...
const cards = ref([
  {
    src: new URL('../../assets/Integração_POWERBI_SQL.gif', import.meta.url).href,
    alt: 'Imagem 1',
  ...
  {
    src: new URL('../../assets/pythonIA.png', import.meta.url).href,
    alt: 'Imagem 2',
  ...
  {
    src: new URL('../../assets/POWERBI_DRE.gif', import.meta.url).href,
    alt: 'Imagem 5',
    title: 'Dashboard DRE',
  ...
  {
    src: new URL('../../assets/Integração_EXCEL_SQL.png', import.meta.url).href,
    alt: 'Imagem 8',
